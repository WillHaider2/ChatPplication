...
from chat_step_5 import initialize_messages, get_chad_response

# load the two images into the code
company_logo = "Images/Chatpplication Company Logo.png"
scout_icon = "Images/Graduation Cap.png"

# this sets up the name in the browser tab
st.set_page_config(
    page_title="ChatPplication, Here To Help Find Your Dream University",
    layout="centered"
)
...
st.title("Chad – Your Virtual Tour Guide")

page_bg_color = "#87CEEB"  # Light Blue
...
user_input = st.chat_input("Ask Chad a question...")
...
if user_input:
    ...
    with st.spinner("Chad is thinking..."):
        response, updated_messages = get_chad_response(
